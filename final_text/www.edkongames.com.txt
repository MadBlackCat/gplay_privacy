...
identification document to the email so Edkon Games can exclude retrieval of your data by unauthorised third parties. If you do not have such an identification document, please contact Edkon Games using the information provided in the site notice so your identity can be verified in a different way.
Revocation
...
Collection of personal data during informational use of the Internet applications of Edkon Games
...
Furthermore, if a mobile device is used, the following data are stored:
...
Use of the functions of the Internet applications of Edkon Games
...
Use of the Edkon Games online shops integrated into the games (IAP)
...
User of the online query; ordering by email, fax or telephone
...
prevent the respective plug-in provider from associating the information with your user account, you should log out of your user account with the respective plug-in provider before clicking on the plug-in on the respective Internet application.
...
Ihren Widerruf richten Sie bitte per E-Mail an datenschutz@edkon-games.de oder per E-Mail, Telefon, Post oder Fax an die im Impressum der Internetanwendungen angegebenen Kontaktdaten.
  Erhebung personenbezogener Daten bei informatorischer Nutzung der Internetanwendungen von Edkon Games
...
Edkon Games weist darauf hin, dass auch die Drittanbieter, die mittels des Einsatzes von Cookies Daten erheben, Daten über die Nutzung der Internetanwendungen von Edkon Games für nutzergenerierte Werbung auf anderen Webseiten nutzen. Auf diese Datenerhebung hat Edkon Games keinen Einfluss.
  Nutzung von Funktionen der Internetanwendungen von Edkon Games
...
Die von Ihnen angegebenen Daten werden von Edkon Games gespeichert, insbesondere um Ihre Anfragen zu beantworten und/oder Ihre Bestellung auszuführen.
  Nutzung der in den Spielen integrierten Edkon Games Online-Shops (IAP)
...
Twitter: Twitter, Inc. 1355 Market St., Suite 900, San Francisco, California 94103 USA – https://twitter.com/privacy?lang=de
Flickr: Yahoo! EMEA Limited, 5-7 Point Village, North Wall Quay Dublin 1 Ireland – https://policies.yahoo.com/us/en/yahoo/privacy/products/flickr/index.htm
Vk: Vkontakte, LLC, 5 Nevskiy Ave., 5th Floor, Saint Petersburg, Russia, 191186 – https://vk.com/privacy
...
info@edkongames.com
© 2017 EDKON GAMES GMBH. ALL RIGHTS RESERVED.TERMS OF USE PRIVACY POLICY SUPPORT